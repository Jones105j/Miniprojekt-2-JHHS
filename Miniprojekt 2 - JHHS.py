...
class Clicks:
    ...
    def draw_clicks(self, surface):
        ...
        #Finding x,y coordinates for top left of nearest grid
            rect = (
            (x // self.marker_size) * self.marker_size, #x_position
            (y // self.marker_size) * self.marker_size, #y_position
...
class Algorithm:
    ...
    def run_algorithm(self):
        #Priority queue for grid positions to explore (always takes lowest cost first)
